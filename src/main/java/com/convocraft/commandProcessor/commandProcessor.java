        ...
        if (words.length > 0) {
            ...
            switch (command) {
                ...
                case "/msg":
                    ...
                    String toSend = "/msg " + user.getUserName() + ": " + profanityFilter.filterProfanityRetainingWhitespace(String.join(" ", Arrays.copyOfRange(words, 1, words.length)),"badWords.txt");
